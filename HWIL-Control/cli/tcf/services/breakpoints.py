...
+-----------------------+--------------+--------------------------------------+
| PROP_CT_INP           | |list|       | Cross trigger input list             |
+-----------------------+--------------+--------------------------------------+
| PROP_CT_OUT           | |list|       | Cross trigger output list            |
+-----------------------+--------------+--------------------------------------+
...
|                       |              | expression.                          |
+-----------------------+--------------+--------------------------------------+
| PROP_SKIP_ON_STEP     | |int |       |  Specify the trigger behaviour on    |
|                       |              | stepping. This option is only        |
|                       |              | applicable for cross trigger         |
|                       |              | breakpoints and when DBGACK is used  |
|                       |              | as breakpoint input. see             |
|                       |              | |Skip On Step|                       |
+-----------------------+--------------+--------------------------------------+
...
| Value    | Description                                 |
+==========+=============================================+
| 0x01     | Trigger every time core is stopped          |
|          | (default).                                  |
+----------+---------------------------------------------+
| 0x02     | suppress trigger on stepping over a code    |
|          | breakpoint.                                 |
+----------+---------------------------------------------+
| 0x03     | suppress trigger on any kind of stepping.   |
+----------+---------------------------------------------+
...
PROP_CT_INP = "CrossTriggerInp"
PROP_CT_OUT = "CrossTriggerOut"
PROP_SKIP_ON_STEP = "SkipOnStep"
