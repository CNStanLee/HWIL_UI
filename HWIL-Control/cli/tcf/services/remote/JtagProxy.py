...
from tcf.services import Service, DoneHWCommand, Token, jtag
...
class JtagProxy(jtag.JtagService):
    ...
    def lock(self, context_id: str, timeout: int, done: DoneHWCommand) -> Token:
        """
    ...
    def claim(self, context_id: str, mask: int, done: DoneHWCommand) -> Token:
        """
        ...
        :return: Token of request
        """
        return self.send_xicom_command("claim", (context_id, mask,), done)

    def disclaim(self, context_id: str, mask: int, done: DoneHWCommand) -> Token:
        """
        ...
        :return: Token of request
        """
        return self.send_xicom_command("disclaim", (context_id, mask,), done)
    ...
    def sequence(
        ...
        :return: Token of request
        """
        return self.send_xicom_command("sequence", (context_id, params, commands, data), done)
